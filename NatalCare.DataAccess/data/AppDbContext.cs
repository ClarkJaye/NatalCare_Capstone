...
namespace NatalCare.DataAccess.data
{
    public class AppDbContext : IdentityDbContext<User>
    {
        ...
        public DbSet<OpdVisit> OPD { get; set; }
        ...
        public DbSet<MaternalMonitoring> MaternalMonitoring { get; set; }
        public DbSet<ProgressLabor> ProgressLabor { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ward>().HasData(
                new Ward { Id = 1, WardNo= "Ward 1"},
                new Ward { Id = 2, WardNo= "Ward 2"}
            );
            modelBuilder.Entity<Bed>().HasData(
               new Bed { Id = 1, BedNo = "Bed 1", IsUsed = false, WardID = 1 },
               new Bed { Id = 2, BedNo = "Bed 2", IsUsed = false, WardID = 1 },
               new Bed { Id = 3, BedNo = "Bed 3", IsUsed = false, WardID = 1 },
               new Bed { Id = 4, BedNo = "Bed 4", IsUsed = false, WardID = 1 },
               new Bed { Id = 5, BedNo = "Bed 5", IsUsed = false, WardID = 1 },
               new Bed { Id = 6, BedNo = "Bed 1", IsUsed = false, WardID = 2 },
               new Bed { Id = 7, BedNo = "Bed 2", IsUsed = false, WardID = 2 },
               new Bed { Id = 8, BedNo = "Bed 3", IsUsed = false, WardID = 2 },
               new Bed { Id = 9, BedNo = "Bed 4", IsUsed = false, WardID = 2 },
               new Bed { Id = 10, BedNo = "Bed 5", IsUsed = false, WardID = 2 }
            );
            ...
            modelBuilder.Entity<Modules>().HasData(
                ...
                //new Modules { ModuleId = 14, ModuleTitle = "Wards", CategoryId = 5, StatusCode = "AC" },
                //new Modules { ModuleId = 15, ModuleTitle = "Beds", CategoryId = 5, StatusCode = "AC" }
            );
