...
namespace NatalCare_System.Controllers
{
    ...
    public class NewbornScreeningController : BaseController<NewbornScreeningController>
    {
        ...
        public NewbornScreeningController(IPatientServices patientServices, IServicesOperationServices serviceServices, IModuleAccessServices moduleAccessServices) : base(moduleAccessServices)
        {
